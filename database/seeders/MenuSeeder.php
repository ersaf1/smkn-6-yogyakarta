...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        MenuItem::create([
            ...
            'parent_id' => $fitur->id,
            'title' => 'Dapodik',
            'url' => 'http://www.smkn6jogja.sch.id/data-dapodik',
            'order' => 2,
            'open_new_tab' => true,
            'is_active' => true,
        ]);
        ...
        MenuItem::create([
            ...
            'parent_id' => $fitur->id,
            'title' => 'Erapor',
            'url' => 'http://erapor.smkn6jogja.sch.id:8154/',
            'order' => 3,
            'open_new_tab' => true,
            'is_active' => true,
        ]);
        ...
        MenuItem::create([
            ...
            'parent_id' => $fitur->id,
            'title' => 'Pemetaan PMP',
            'url' => 'http://pmp.dikdasmen.kemdikbud.go.id:1745/',
            'order' => 5,
            'open_new_tab' => true,
            'is_active' => true,
        ]);
        ...
        MenuItem::create([
            'menu_id' => $mainMenu->id,
            'parent_id' => $lulusan->id,
            'title' => 'BKK SMKN 6 Yogyakarta',
            'url' => '/bkk-smkn-6-yogyakarta',
            'order' => 1,
            'is_active' => true,
        ]);
